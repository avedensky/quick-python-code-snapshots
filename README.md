...
<a href="https://github.com/avedensky/SamplesOffPython/blob/master/files_remove/remove_files_by_time.py">Script check selected files by mask in directory and send files to FTP server</a><br>